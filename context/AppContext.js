...
const AppProvider = ({ children }) => {
  ...
  return (
    <AppContext.Provider value={{ selectedCuisines, toggleSelectedCuisines, selectedStars, toggleSelectedStars, location, handleSetLocation, errorMsg, handleSetErrorMsg }}>
      {children}
    </AppContext.Provider>
  );
};
